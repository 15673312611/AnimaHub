...
export default function RegisterPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-black text-white p-4 relative overflow-hidden">
      {/* Background Glow */}
      <div className="absolute top-[-200px] right-[-200px] w-[500px] h-[500px] bg-purple-900/30 blur-[100px] rounded-full pointer-events-none"></div>
      <div className="absolute bottom-[-200px] left-[-200px] w-[500px] h-[500px] bg-pink-900/20 blur-[100px] rounded-full pointer-events-none"></div>

      <Card className="w-full max-w-md bg-white/5 border-white/10 text-white relative z-10 backdrop-blur-sm">
        <CardHeader className="space-y-1 text-center">
          <CardTitle className="text-2xl font-bold tracking-tight">创建新账号</CardTitle>
          <CardDescription className="text-gray-400">输入您的邮箱开始您的 AI 创作之旅</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="password" className="text-gray-300">设置密码</Label>
              <Input
                id="password"
                type="password"
                required
                ...
                className="bg-black/30 border-white/10 focus-visible:ring-purple-500"
              />
              <p className="text-xs text-gray-500">密码至少需要 6 个字符</p>
            </div>
